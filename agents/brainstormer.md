...
Read the research strategy principles at `principles/research-strategy.md` in this repository. Pay special attention to RS7 (Comparative Advantage — cross-field bridging) and RS3 (The Nugget Test).
