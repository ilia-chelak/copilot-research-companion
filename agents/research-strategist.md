...
Project-level strategic thinking — triage (continue/pivot/kill), comparative advantage mapping, impact forecasting, opportunity cost analysis, and scooping risk assessment.
...
Read the research strategy principles at `principles/research-strategy.md` in this repository.
